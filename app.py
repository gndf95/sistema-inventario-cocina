...
def ver_equipo(id):
    ...
    historial = DetallePrestamo.query.filter_by(tipo_equipo_id=id).join(Prestamo).order_by(Prestamo.fecha_prestamo.desc()).all()
...
# Agregar estas funciones en app.py
...
if __name__ == '__main__':
    ...
    # Para acceso en red local, usa host='0.0.0.0'
